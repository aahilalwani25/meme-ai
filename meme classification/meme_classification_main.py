...
def get_model():
    ...
    global lr_model
    global vectorizer
    rf_model=pickle.load(open(r"meme classification/rf_model.pkl", "rb"))
    knc_model=pickle.load(open(r"meme classification/knc_model.pkl", "rb"))
    etc_model=pickle.load(open(r"meme classification/etc_model.pkl", "rb"))
    sgd_model=pickle.load(open(r"meme classification/sgd_model.pkl", "rb"))
    mnb_model=pickle.load(open(r"meme classification/mnb_model.pkl", "rb"))
    lr_model=pickle.load(open(r"meme classification/lr_model.pkl", "rb"))
    vectorizer=pickle.load(open(r"meme classification/vectorizer.pkl", "rb"))
